...
public abstract class AbstractArchitectCamActivity extends Activity implements ArchitectViewHolderInterface{
            ...
            final Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (lastKnownLocaton!=null && !isFinishing()) {
                        poiData = getPoiInformation(lastKnownLocaton);
    ...
    private static JSONObject getPOI(int id, String name, String description,
                                     final Location userLocation, double lat, double lon) {
        ...
        poiInformation.put(ATTR_ID, String.valueOf(id));
        poiInformation.put(ATTR_NAME, name);
        poiInformation.put(ATTR_DESCRIPTION, description);
//        poiInformation.put(ATTR_LATITUDE, String.valueOf(userLocation.getLatitude()+lat));
//        poiInformation.put(ATTR_LONGITUDE, String.valueOf(userLocation.getLongitude()+lon));
